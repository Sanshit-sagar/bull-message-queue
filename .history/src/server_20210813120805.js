...
function createLexicographicalKeySet(owner, slug, cfRay, timestamp) {
    ...
    const userLexicographicalKey = createLexicographicalKey(timestamp, userFragmentsArr);
    const slugFragmentsArr = [...fragmentsArr, `${slug}`, `${owner}`]; 
    const slugLexicographicalKey = createLexicographicalKey(timestamp, slugFragmentsArr); 

    console.log(`${lexicographicalKey}`);
    console.log(`${userLexicographicalKey}`);
    console.log(`${slugLexicographicalKey}`);
}
