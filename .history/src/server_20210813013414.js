...
testApiQueue.process(async (job) => {
    ...
    const redisResult4 = await redis.lpush('test-queue2', JSON.stringify(responseData));
    const redisResult5 = await redis.lpush('test-queue2', JSON.stringify(requestData));
