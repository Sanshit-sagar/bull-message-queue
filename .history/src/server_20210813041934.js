...
testApiQueue.process(async (job) => {
    ...
    const redisResult3 = await redis.lpush('clickstream.requests', JSON.stringify(requestHeaders));
    const redisResult4 = await redis.lpush('clickstream.responses', JSON.stringify(responseHeaders));
